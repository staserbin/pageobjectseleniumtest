...
public class MainPageHeaderMenu {
    ...
    /* Explore drop-down */
    private By Eplore = By.xpath("//header/div[1]/div[2]/nav[1]/ul[1]/li[4]/details[1]/summary[1]");
    private By explrExploreGitHub = By.xpath("//header/div[1]/div[2]/nav[1]/ul[1]/li[4]/details[1]/div[1]/ul[1]/li[1]/a[1]");
    private By explrLearnContribute = By.xpath("//h4[contains(text(),'Learn & contribute')]");
    ...
    private By explrConnectWithOthers = By.xpath("//h4[contains(text(),'Connect with others')]");
